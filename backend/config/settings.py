...
if os.getenv("DATABASE_URL") and os.getenv("USE_SQLITE", "false").lower() != "true":
...
FRONTEND_URL = os.getenv("FRONTEND_URL", f"https://{VERCEL_HOST}" if VERCEL_HOST else "http://localhost:5173").rstrip("/")
